...
export default function Layout() {
  const { user, profile, signOut, isTeacher, isAdmin, isStudent } = useAuth();
                      ...
                      <div className="space-y-2">
                        <div className="flex gap-2">
                          <input
                            ...
                            autoFocus
                          />
                          <button onClick={handleJoinClass} className="px-2 py-1 text-sm bg-gray-900 text-white rounded hover:bg-gray-800">Join</button>
                        </div>
                        ...
                        <button onClick={() => { setShowJoin(false); setJoinStatus(null); }} className="text-xs text-gray-400 hover:text-gray-600">Cancel</button>
                      </div>
                    )}
                  </div>
                )}
